...
get_filename_component(GRAPHQL_UPDATE_SCHEMA_FILES_SCRIPT
  "${CMAKE_CURRENT_LIST_DIR}/custom-cppgraphqlgen-update-schema-files.cmake"
  ABSOLUTE)

get_filename_component(GRAPHQL_UPDATE_CLIENT_FILES_SCRIPT
  "${CMAKE_CURRENT_LIST_DIR}/custom-cppgraphqlgen-update-client-files.cmake"
  ABSOLUTE)
...
function(update_graphql_schema_files SCHEMA_TARGET SCHEMA_GRAPHQL SCHEMA_PREFIX SCHEMA_NAMESPACE)
  ...
  add_custom_command(
    ...
    COMMAND
      ...
      "-DSCHEMAGEN_PROGRAM=$<TARGET_FILE:custom-cppgraphqlgen::schemagen>"
    ...
    DEPENDS ${SCHEMA_GRAPHQL} ${GRAPHQL_UPDATE_SCHEMA_FILES_SCRIPT} custom-cppgraphqlgen::schemagen
...
function(add_graphql_schema_target SCHEMA_TARGET)
  ...
  if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/${SCHEMA_TARGET}_schema_files)
    ...
    target_link_libraries(${SCHEMA_TARGET}_schema PUBLIC custom-cppgraphqlgen::graphqlservice)
  endif()
endfunction()
...
function(update_graphql_client_files CLIENT_TARGET SCHEMA_GRAPHQL REQUEST_GRAPHQL CLIENT_PREFIX CLIENT_NAMESPACE)
  ...
  add_custom_command(
    ...
    COMMAND
      ...
      "-DCLIENTGEN_PROGRAM=$<TARGET_FILE:custom-cppgraphqlgen::clientgen>" "-DCLIENT_TARGET=${CLIENT_TARGET}"
    ...
    DEPENDS ${SCHEMA_GRAPHQL} ${REQUEST_GRAPHQL} ${GRAPHQL_UPDATE_CLIENT_FILES_SCRIPT} custom-cppgraphqlgen::clientgen
...
function(add_graphql_client_target CLIENT_TARGET)
  ...
  if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/${CLIENT_TARGET}_client_files)
    ...
    target_link_libraries(${CLIENT_TARGET}_client PUBLIC custom-cppgraphqlgen::graphqlclient)
  endif()
endfunction()
